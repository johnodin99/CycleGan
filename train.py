...
tf.flags.DEFINE_string('X', 'data/tfrecords/Good.tfrecords',
                       'X tfrecords file for training, default: data/tfrecords/Good.tfrecords')
tf.flags.DEFINE_string('Y', 'data/tfrecords/Bad.tfrecords',
                       'Y tfrecords file for training, default: data/tfrecords/Bad.tfrecords')
